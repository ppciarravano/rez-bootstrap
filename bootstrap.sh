...
then
    ...
    sed -i 's,__COMP_GCC_VERS__,'"${COMP_GCC_VERS}"',' ${BOOTSTRAP_PATH}/rez_init.sh
    sed -i 's,__COMP_PYTHON_VERS__,'"${COMP_PYTHON_VERS}"',' ${BOOTSTRAP_PATH}/rez_init.sh
    sed -i 's,__COMP_CMAKE_VERS__,'"${COMP_CMAKE_VERS}"',' ${BOOTSTRAP_PATH}/rez_init.sh
